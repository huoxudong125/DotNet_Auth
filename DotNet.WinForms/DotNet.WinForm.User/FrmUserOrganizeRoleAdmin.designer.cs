...
namespace DotNet.WinForm.User
{
    partial class FrmUserOrganizeRoleAdmin
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ucStaffSelect = new DotNet.WinForm.Common.WinControls.UCStaffSelect();
            ...
            this.ucStaffSelect.SelectedIndexChanged += new BaseBusinessLogic.SelectedIndexChangedEventHandler(this.ucStaffSelect_SelectedIndexChanged);
            // 
            // lblParentReq
            // 
        ...
        private DotNet.WinForm.Common.WinControls.UCStaffSelect ucStaffSelect;
