...
using DotNet.Utilities.Base;
using DotNet.Utilities.ResourceManager;
    ...
    public partial class FrmOrganizePermission : BaseForm
    {
        ...
        private void tvModule_AfterCheck(object sender, TreeViewEventArgs e)
        {
            if (this.isUserClick)
            {
                ...
                {
                    // 授予操作权限
                    DotNetService.Instance.PermissionService.GrantOrganizeModuleScope(this.UserInfo, this.TargetOrganizeId, "Resource.AccessPermission", (e.Node.Tag as DataRow)[BaseModuleEntity.FieldId].ToString());
                }
                else
                {
                    // 撤销操作权限
                    DotNetService.Instance.PermissionService.RevokeOrganizeModuleScope(this.UserInfo, this.TargetOrganizeId, "Resource.AccessPermission", (e.Node.Tag as DataRow)[BaseModuleEntity.FieldId].ToString());
                }
        ...
        private void tvPermissionItem_AfterCheck(object sender, TreeViewEventArgs e)
        {
            if (this.isUserClick)
            {
                ...
                {
                    // 授予操作权限
                    DotNetService.Instance.PermissionService.GrantOrganizePermissionById(this.UserInfo, this.TargetOrganizeId, (e.Node.Tag as DataRow)[BaseModuleEntity.FieldId].ToString());
                }
                else
                {
                    // 撤销操作权限
                    DotNetService.Instance.PermissionService.RevokeOrganizePermissionById(this.UserInfo, this.TargetOrganizeId, (e.Node.Tag as DataRow)[BaseModuleEntity.FieldId].ToString());
                }
