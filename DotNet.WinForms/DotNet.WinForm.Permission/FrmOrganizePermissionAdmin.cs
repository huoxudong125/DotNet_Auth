...
using DotNet.WinForm.ItemDetails;
using DotNet.WinForm.Organization;
...
namespace DotNet.WinForm.Permission
{
    ...
    /// </author> 
    /// </summary>    
    public partial class FrmOrganizePermissionAdmin : BaseForm, IBaseForm
    {
        /// <summary>
        /// 新增组织机构权限
        /// </summary>
        ...
        public FrmOrganizePermissionAdmin()
        {
            InitializeComponent();
        }
        ...
        private bool OnAdded(string parentId, string fullName, string id)
        {
            ...
            BaseInterfaceLogic.FindTreeNode(this.tvOrganize, BaseModuleEntity.FieldId, parentId);
            //if (BaseInterfaceLogic.TargetNode != null)
            //{
            this.tvOrganize.SelectedNode = BaseInterfaceLogic.TargetNode;
        ...
        private void btnPermission_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    string realName = dataRow[BaseOrganizeEntity.FieldFullName].ToString();
