...
namespace DotNet.Manager.Common
{
    ...
    /// 	</author>
    /// </summary>
    public partial class CopyOfBaseNewsManager : BaseManager, IBaseManager
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public CopyOfBaseNewsManager()
        {
            if (base.dbHelper == null)
            {
                base.dbHelper = DbHelperFactory.GetHelper(BaseSystemInfo.UserCenterDbType, BaseSystemInfo.UserCenterDbConnection);
        ...
        /// <param name="tableName">指定表名</param>
        /// </summary>
        public CopyOfBaseNewsManager(string tableName)
        {
            base.CurrentTableName = tableName;
        }
        ...
        /// </summary>
        /// <param name="dbHelper">数据库连接</param>
        public CopyOfBaseNewsManager(IDbHelper dbHelper)
            : this()
        {
            DbHelper = dbHelper;
        }
        ...
        /// </summary>
        /// <param name="userInfo">操作员信息</param>
        public CopyOfBaseNewsManager(BaseUserInfo userInfo)
            : this()
        {
            UserInfo = userInfo;
        }
        ...
        /// <param name="dbHelper">数据库连接</param>
        /// <param name="userInfo">操作员信息</param>
        public CopyOfBaseNewsManager(IDbHelper dbHelper, BaseUserInfo userInfo)
            : this(dbHelper)
        {
            UserInfo = userInfo;
        }
        ...
        /// <param name="userInfo">操作员信息</param>
        /// <param name="tableName">指定表名</param>
        public CopyOfBaseNewsManager(IDbHelper dbHelper, BaseUserInfo userInfo, string tableName)
            : this(dbHelper, userInfo)
        {
            base.CurrentTableName = tableName;
        }
