...
using DotNet.WinForm.Login;
using DotNet.WinForm.Message;
using DotNet.WinForm.User;
...
namespace DotNet.WinForm
{
    ...
    public partial class TabsMainForm : BaseForm, IBaseMainForm
    {
        ...
        public override void FormOnLoad()
        {
            ...
            this.Hide();
            // 这里显示登录窗体
            BaseSystemInfo.MainAssembly = "DotNet.WinForm.Login";
        ...
        {
            var frmAboutThis = new FrmAboutThis();
        ...
        {
            var frmUserChangePassword = new FrmUserChangePassword();
