...
namespace DotNet.DbUtilities
{
    ...
    public class DbHelper
    {
        ...
        public static string GetDbHelperClass(DbTypes dbType)
        {
            string returnValue = "DotNet.DbUtilities.SqlHelper";
            switch (dbType)
            {
                case DbTypes.SqlServer:
                    returnValue = "DotNet.DbUtilities.SqlHelper";
                    break;
                case DbTypes.Oracle:
                    returnValue = "DotNet.DbUtilities.MSOracleHelper";
                    break;
                case DbTypes.Access:
                    returnValue = "DotNet.DbUtilities.OleDbHelper";
                    break;
                case DbTypes.MySql:
                    returnValue = "DotNet.DbUtilities.MySqlHelper";
                    break;
                case DbTypes.DB2:
                    returnValue = "DotNet.DbUtilities.DB2Helper";
                    break;
                case DbTypes.SQLite:
                    returnValue = "DotNet.DbUtilities.SqLiteHelper";
                    break;
            }
            return returnValue;
        }
        ...
        /// 数据库类型，这里也是为了简化思路
        /// </summary>
        public static DbTypes DbType = BaseSystemInfo.BusinessDbType;
