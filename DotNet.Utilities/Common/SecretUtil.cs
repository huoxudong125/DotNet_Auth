...
namespace DotNet.Utilities.Common
{
    public class SecretUtil
    {
        ...
        #endregion public static bool CheckRegister() 检查注册码是否正确
        ...
        public static string md5(string password, int codeLength)
        {
            if (!string.IsNullOrEmpty(password))
            {
                ...
                if (codeLength == 16)
                {
                    var hashPasswordForStoringInConfigFile = System.Web.Security.FormsAuthentication.HashPasswordForStoringInConfigFile(password, "MD5");
                    if (hashPasswordForStoringInConfigFile !=
                        null)
                        return hashPasswordForStoringInConfigFile.ToLower().Substring(8, 16);
                }
        ...
        #endregion 16位MD5加密 public static string MD5Encrypt16(string password)
        ...
        #endregion 32位MD5加密 public static string MD5Encrypt32(string password)
