...
namespace DotNet.Utilities.Base
{
    /// <summary>
    ///	BaseBusinessLogic
    /// 通用基类
    ...
    public partial class BaseBusinessLogic
    {
        ...
        public static bool IsKeywords(string field)
        {
            ...
            string[] keywords = { "Id", "SortCode", "DeletionStateCode", "Enabled", "CreateOn", "CreateUserId", "CreateBy", "ModifiedOn", "ModifiedUserId", "ModifiedBy" };
